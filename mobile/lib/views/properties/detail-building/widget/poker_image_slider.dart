...
import 'package:mobile_nirwana/views/properties/detail-building/widget/all_photos_grid.dart';
...
class _PokerCardImageSliderState extends State<PokerCardImageSlider> {
  ...
  int _currentIndex = 0;
  late final List<BuildingImages> _validImages;
        ...
        PageView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final String fullUrl =
                Imgurl.get('building_property/building_images/$filename');
