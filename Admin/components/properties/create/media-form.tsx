      ...
      <TabsContent value="media">
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center h-[200px] flex flex-col items-center justify-center">
                  ...
                  <p className="text-sm text-gray-600 mb-2">Upload gambar property satu per satu</p>
                  <input
                    type="file"
                    accept="image/*"
                    onChange={(e) => {
            ...
            <Card>
              <CardHeader>
                <CardTitle>Denah Lokasi</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Upload Area - Fixed Height */}
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center h-[200px] flex flex-col items-center justify-center">
                  <Upload className="w-8 h-8 mx-auto mb-2 text-gray-400" />
                  <p className="text-sm text-gray-600 mb-2">Upload denah lokasi satu per satu</p>
                  <input
                    type="file"
                    accept="image/*,.pdf"
                    onChange={(e) => {
                        ...
                        <div key={index} className="flex items-start gap-4 p-4 border rounded-lg bg-gray-50">
                          ...
                          <div className="flex-shrink-0 relative">
                            <div className="w-20 h-20 bg-gray-100 rounded border flex items-center justify-center">
                              {site.file!.type.startsWith("image/") ? (
                                <img src={site.preview} alt="Floor plan" className="w-full h-full object-cover rounded cursor-pointer" onClick={() => handleImagePreview(site.preview!)} />
                              ) : (
