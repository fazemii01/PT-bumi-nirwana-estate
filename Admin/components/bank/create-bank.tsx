...
const CreateBank = ({ open, setOpen }: { open: boolean; setOpen: (value: boolean) => void }) => {
  ...
  const validate = () => {
    ...
    if (!form.interest_rate || form.interest_rate <= 0) newErrors.interest_rate = "Interest rate must be greater than 0";
    if (!form.max_tenure || form.max_tenure <= 0) newErrors.max_tenure = "Max tenure must be greater than 0";
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="name" name="name" value={form.name} onChange={handleChange} placeholder="Enter full name" />
