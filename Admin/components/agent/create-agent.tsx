...
const CreateAgent = ({ open, setOpen }: { open: boolean; setOpen: (value: boolean) => void }) => {
  ...
  const validate = () => {
    ...
    if (!selectedFile) newErrors.avatar = "Profile image is required";
    return newErrors;
  };
      ...
      <AlertDialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          <AlertDialogHeader className="space-y-3">
            ...
            <AlertDialogDescription className="text-gray-600">Fill in the information below to create a new agent profile.</AlertDialogDescription>
          </AlertDialogHeader>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              >
                  ...
                  {selectedFile && previewUrl ? (
                    <div className="text-center space-y-3">
                      ...
                      <div className="relative">
                        <img src={previewUrl} alt="Preview" className="w-24 h-24 object-cover rounded-lg border-2 border-gray-200 shadow-sm" />
                        <button
                          type="button"
                          onClick={(e) => {
                            e.preventDefault();
                ...
                <input type="file" id="input-file" name="file_avatar" className="hidden" accept="image/*" onChange={handleFileSelect} />
              </div>
